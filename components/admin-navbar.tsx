...
export function AdminNavbar({ user, searchPlaceholder = "Zoeken..." }: AdminNavbarProps) {
      ...
      <div className="flex h-16 items-center px-4 lg:px-6">
        ...
        <div className="flex items-center space-x-4 lg:space-x-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-xl text-gray-900 hidden sm:inline-block">Parcxl Admin</span>
          </div>
        </div>
