...
import { CCVSetupClient } from "./ccv-setup-client"
...
export default async function CCVIntegrationPage({ params }: PageProps) {
  ...
  return <CCVSetupClient tenant={tenant} user={user} clientId={params.id} clientName={client.company_name} />
}
