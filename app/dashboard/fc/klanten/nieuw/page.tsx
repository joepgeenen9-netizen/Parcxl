...
import { NewClientWizardStep1 } from "./new-client-wizard-step1"
...
export default async function NewClientPage() {
  ...
  return (
    <FCLayout tenant={tenant} user={user} searchPlaceholder="Zoek klanten...">
      <NewClientWizardStep1 tenantId={tenant.id} />
    </FCLayout>
  )
}
